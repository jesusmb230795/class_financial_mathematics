...
This note introduces the economic function, institutional structure, and price formation process of stock markets. It provides the conceptual background needed before working with market data in Python.

## Learning objectives

- Explain how stock markets connect issuers, investors, brokers, and exchanges.
- Distinguish between a stock market, a stock exchange, and a market index.
- Identify the main forces that affect market prices.
- Connect market microstructure concepts with the later data extraction and EDA notebooks.

## Lesson flow

1. Review why companies issue equity and why investors buy it.
2. Distinguish exchanges, markets, indices, and other asset markets.
3. Discuss the economic and institutional forces that move prices.
4. Prepare for the transition from concepts to data extraction.

## Student deliverable

Write a one-page market briefing that explains the role of one stock exchange, one stock index, and three price drivers for a selected company.
